...
[[nodiscard]] void* operator new[](size_t) throw(bad_alloc) {}
[[nodiscard, gnu::malloc, gnu::alloc_size(1)]] void* operator new[](size_t, align_val_t);
[[nodiscard, gnu::malloc, gnu::alloc_size(1)]] void* operator new[](size_t, const nothrow_t&) noexcept;
[[nodiscard, gnu::malloc, gnu::alloc_size(1)]] void* operator new[](size_t, align_val_t, const nothrow_t&);
