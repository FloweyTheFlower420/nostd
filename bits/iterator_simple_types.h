...
template <typename C, typename T, typename D = ptrdiff_t, typename P = T *,
          typename R = T &>
struct iterator {
...
namespace detail {
template <typename I, typename = void_t<>> struct iterator_traits_helper {};

template <typename I>
struct iterator_traits_helper<
    I, void_t<typename I::iterator_category, typename I::value_type,
...
template <typename I>
using require_input_ierator = enable_if_t<
    is_convertible<iterator_category_t<I>, input_iterator_tag>::value>;
