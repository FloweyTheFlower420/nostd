...
namespace std {
template <typename I> class move_iterator {
  I iter;
  template <typename It> friend class move_iterator;
...
public:
  ...
  using reference = conditional_t<
      is_reference_v<typename iterator_traits<I>::reference>,
  ...
  operator-(const move_iterator<ItR> &rhs) {
...
template <typename It>
[[nodiscard]] inline constexpr bool operator==(const move_iterator<It> &lhs,
                                               const move_iterator<It> &rhs) {
...
template <typename ItL, typename ItR>
[[nodiscard]] inline constexpr bool operator==(const move_iterator<ItL> &lhs,
                                               const move_iterator<ItR> &rhs) {
  return lhs.base() == rhs.base();
}
...
template <typename It>
[[nodiscard]] inline constexpr move_iterator<It>
