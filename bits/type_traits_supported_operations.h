...
template <typename T> using make_mc_param = add_rvalue_reference<T>;
} // namespace detail
...
using is_trivially_copy_constructible =
    is_trivially_constructible<T, detail::make_cc_param<T>>;
template <typename T>
using is_nothrow_copy_constructible =
    is_nothrow_constructible<T, detail::make_cc_param<T>>;
...
using is_trivially_move_constructible =
    is_trivially_constructible<T, detail::make_mc_param<T>>;
template <typename T>
using is_nothrow_move_constructible =
    is_nothrow_constructible<T, detail::make_mc_param<T>>;
...
using is_copy_assignable =
    is_assignable<add_lvalue_reference_t<T>, detail::make_cc_param<T>>;
template <typename T>
using is_trivially_copy_assignable =
    is_trivially_assignable<add_lvalue_reference_t<T>,
                            detail::make_cc_param<T>>;
template <typename T>
using is_nothrow_copy_assignable =
    is_nothrow_assignable<add_lvalue_reference_t<T>, detail::make_cc_param<T>>;
...
using is_move_assignable =
    is_assignable<add_lvalue_reference_t<T>, detail::make_mc_param<T>>;
template <typename T>
using is_trivially_move_assignable =
    is_trivially_assignable<add_lvalue_reference_t<T>,
                            detail::make_mc_param<T>>;
template <typename T>
using is_nothrow_move_assignable =
    is_nothrow_assignable<add_lvalue_reference_t<T>, detail::make_mc_param<T>>;
...
template <typename T> constexpr bool is_nothrow_destructible_helper() {
...
using is_nothrow_destructible =
    bool_constant<detail::is_nothrow_destructible_helper<T>()>;
...
namespace detail {
template <typename T, typename U> struct is_swappable_helper {
...
template <typename T, typename U> constexpr bool is_nothrow_swappable_helper() {
  if constexpr (is_swappable_helper<T, U>::type::value)
    return noexcept(swap(declval<T &>(), declval<U &>())) &&noexcept(
...
template <typename T> using is_swappable = detail::is_swappable_helper<T, T>;
template <typename T, typename U>
using is_swappable_with = conjunction<detail::is_swappable_helper<T, U>,
                                      detail::is_swappable_helper<U, T>>;
template <typename T>
using is_nothrow_swappable =
    bool_constant<detail::is_nothrow_swappable_helper<T, T>()>;
template <typename T, typename U>
using is_nothrow_swappable_with =
    bool_constant<detail::is_nothrow_swappable_helper<T, U>()>;
