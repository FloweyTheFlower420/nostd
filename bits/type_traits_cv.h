...
template <typename T>
struct is_integral
    : matches_any<is_same, remove_cv_t<T>, bool, char, char32_t, wchar_t, short,
                  int, long, long long, __int128> {};
template <typename T>
inline constexpr bool is_integral_v = is_integral<T>::value;

template <typename T>
struct is_floating_point
    : matches_any<is_same, remove_cv_t<T>, float, double, long double> {};
template <typename T>
