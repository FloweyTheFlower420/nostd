...
template <typename T> class forward_list {
  ...
  public:
    ...
    [[nodiscard]] friend bool operator==(const iterator &x,
  ...
  public:
    ...
    [[nodiscard]] friend bool operator==(const const_iterator &__x,
                                         const const_iterator &__y) noexcept {
...
public:
  ...
  const_iterator before_begin() const noexcept {
    return const_iterator((__data *)&start);
  }
  ...
  iterator insert_after(const_iterator pos, initializer_list<T> il) {
    insert_after(pos, il.begin(), il.end());
  }
