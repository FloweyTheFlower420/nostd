...
namespace std
{
    namespace detail
    {
        ...
        struct array_helper
        {
            ...
            static constexpr T* ptr(const type& t, size_t index) noexcept { return &t[index]; }
            static constexpr T& ref(const type& t, size_t index) noexcept { return t[index]; }
        };
        ...
        struct array_helper<T, 0>
        {
            ...
            static constexpr T* ptr(const type& t, size_t index) noexcept { return nullptr; }
            static constexpr T& ref(const type& t, size_t index) noexcept { return *ptr(t, index); }
        };
    } // namespace detail
    template <typename T, size_t N>
    struct array
